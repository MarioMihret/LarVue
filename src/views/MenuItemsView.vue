<template>
  <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center gap-8">
            ...
            <nav class="flex gap-1">
              ...
              <RouterLink
                to="/menu-items"
                class="px-4 py-2 rounded-lg text-gray-900 bg-gray-100"
              >
                Menu Items
              </RouterLink>
            </nav>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col sm:flex-row gap-4">
          ...
          <button
            ...
            :class="showFavoritesOnly ? 'bg-yellow-100 text-yellow-700 border border-yellow-300' : 'bg-gray-100 text-gray-700 border border-gray-300'"
          >
      ...
      <!-- Error State -->
      <div v-else-if="menuItemStore.error" class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
        {{ menuItemStore.error }}
      </div>
      ...
      <div v-else class="space-y-6">
        <div v-for="group in groupedItems" :key="group.categoryId" class="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div class="p-4">
                ...
                <div class="space-y-1 text-sm text-gray-600 mb-3">
                  <div class="flex justify-between">
                    <span>Price:</span>
                    <span class="font-medium text-gray-900">${{ Number(item.price).toFixed(2) }}</span>
                  </div>
                  <div class="flex justify-between">
                    <span>Tax:</span>
