    ...
    <div class="max-w-md w-full">
      <div class="bg-white rounded-xl shadow-sm p-8">
        ...
        <div class="text-center mb-8">
          ...
          <p class="mt-2 text-sm text-gray-600">Start your free trial today</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5" novalidate>
          ...
          <FormInput
            ...
            @toggle="field.id === 'password' ? (showPassword = !showPassword) : (showConfirmPassword = !showConfirmPassword)"
          >
            <template v-if="field.id === 'password' && formData.password && !errors.password" #extra>
          ...
          <div class="flex items-start">
            ...
            <label for="terms" class="ml-2 block text-sm text-gray-700 cursor-pointer">
              I agree to the <a href="#" class="text-gray-900 hover:underline font-medium">Terms of Service</a> 
              and <a href="#" class="text-gray-900 hover:underline font-medium">Privacy Policy</a>
            </label>
          </div>
          <p v-if="errors.acceptTerms" class="-mt-3 text-sm text-red-600">{{ errors.acceptTerms }}</p>
          ...
          <button
            ...
            :class="[
              ...
              isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-gray-900 hover:bg-gray-800 active:scale-[0.98] text-white'
            ]"
          >
          ...
          <p class="text-center text-sm text-gray-600">
            ...
            <RouterLink to="/login" class="font-medium text-gray-900 hover:underline transition-colors">
              Sign in
            </RouterLink>
          </p>
        </form>
...
import {
  ...
  IdentificationIcon, LockClosedIcon, EyeIcon, EyeSlashIcon, UserPlusIcon
...
const formData: Record<string, string | boolean> = reactive({
  ...
  business_name: '', tin: '', acceptTerms: false
})
...
const validateBusinessName = () => validateField('business_name', formData.business_name as string, 2)
...
const formFields = computed(() => [
  { id: 'name', label: 'Full Name', type: 'text', placeholder: 'John Doe', icon: UserIcon, validate: validateName },
  { id: 'email', label: 'Email Address', type: 'email', placeholder: 'you@example.com', icon: EnvelopeIcon, validate: validateEmail },
  { id: 'phone', label: 'Phone Number', type: 'tel', placeholder: '09xxxxxxxx', icon: PhoneIcon, validate: validatePhone },
  { id: 'business_name', label: 'Business Name', type: 'text', placeholder: 'ABC Restaurant', icon: BuildingOfficeIcon, validate: validateBusinessName },
  { id: 'tin', label: 'TIN', type: 'text', placeholder: '123456789', icon: IdentificationIcon, validate: validateTin },
  { id: 'password', label: 'Password', type: 'password', placeholder: '••••••••', icon: LockClosedIcon, showToggle: true, isVisible: showPassword.value, validate: validatePassword },
  { id: 'confirmPassword', label: 'Confirm Password', type: 'password', placeholder: '••••••••', icon: LockClosedIcon, showToggle: true, isVisible: showConfirmPassword.value, validate: validateConfirmPassword },
])
