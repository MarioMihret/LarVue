  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="businessStore.loading" class="text-center py-12">
        ...
        <p class="text-gray-600 mt-2">Loading businesses...</p>
      </div>

      <!-- Error State -->
      <div v-else-if="businessStore.error" class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
        {{ businessStore.error }}
      </div>
      ...
      <div v-else class="bg-white rounded-lg shadow-sm overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="business in businessStore.businesses" :key="business.id" class="hover:bg-gray-50">
