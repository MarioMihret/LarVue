<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- Error State -->
      <div v-else-if="categoryStore.error" class="bg-red-50 border border-red-200 rounded-lg p-4 text-red-700">
        {{ categoryStore.error }}
      </div>

      <!-- Empty State -->
      <div v-else-if="filteredCategories.length === 0" class="text-center py-12 bg-white rounded-lg border border-gray-200">
      ...
      <!-- Pagination -->
      <div v-if="categoryStore.pagination.last_page > 1" class="mt-8 flex justify-center items-center gap-2">
        <button
        ...
        <span class="px-4 py-2 text-gray-700">
          Page {{ categoryStore.pagination.current_page }} of {{ categoryStore.pagination.last_page }}
        </span>
        <button
          @click="changePage(categoryStore.pagination.current_page + 1)"
    ...
    <!-- Image Preview Modal -->
    <Teleport to="body">
      <div v-if="viewingImage" class="fixed inset-0 z-[60] overflow-y-auto" @click.self="viewingImage = null">
        <div class="flex min-h-screen items-center justify-center px-4">
          <div class="fixed inset-0 bg-black bg-opacity-75 transition-opacity" @click="viewingImage = null"></div>
          ...
          <div class="relative max-w-4xl w-full z-10" @click.stop>
            ...
            <div class="mt-4 text-center">
              ...
              <p v-if="viewingImage.description" class="text-gray-300 mt-2">{{ viewingImage.description }}</p>
            </div>
          </div>
        </div>
      </div>
...
import { PlusIcon, PencilIcon, TrashIcon, PhotoIcon, FolderIcon, EyeIcon, XMarkIcon } from '@heroicons/vue/24/outline'
